...
export default function Navbar() {
    ...
    return(
        // ========== HEADER =========
        <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 py-7 max-sm:py-1 w-full bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900 text-white">
            <nav className="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-6  mx-auto" aria-label="Global">
                ...
                <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6">
                    <div
                        ...
                        <div>
                            <a className="relative inline-block text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-secondary-400 dark:text-white"
                               href="/" aria-current="page">Beranda</a>
                        </div>
                        <div>
                            <a className="inline-block text-black hover:text-primary-600 dark:text-white dark:hover:text-neutral-300"
                               href="/transactions/history">Riwayat Pesanan</a>
                        </div>
                        <div>
                            <a className="inline-block text-black hover:text-primary-600 dark:text-white dark:hover:text-neutral-300"
                               href="#">Tentang</a>
