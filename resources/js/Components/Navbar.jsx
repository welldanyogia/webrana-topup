        ...
        <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7">
            <nav className="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-6  mx-auto" aria-label="Global">
                <div className="md:col-span-3">
                    {/*// <!-- Logo -->*/}
                    <a className="flex-none border-2 border-white rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="/" aria-label="Preline">
                        ...
                        {/*</svg>*/}
                        {/*<WebranaLogoBlack/>*/}
                        <img src='/logo_dark.png' width={145}/>
                    </a>
                    {/*// <!-- End Logo */}
                </div>
