export default function NumberFieldUser({form,handleChange}) {
    return (
        <div className="relative">
            <input type="number" id={`hs-floating-primary-input-${form.id}`} className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none peer p-4 block w-full bg-primary-100 border-transparent rounded-lg text-sm placeholder:text-transparent focus:border-secondary-500 focus:ring-secondary-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-transparent dark:text-neutral-400 dark:focus:ring-neutral-600
                                                    focus:pt-6
                                                    focus:pb-2
            ...
            />
            <label htmlFor={`hs-floating-primary-input-${form.id}`}
